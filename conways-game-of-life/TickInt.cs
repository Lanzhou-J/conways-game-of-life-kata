        ...
        public static int[] GetNeighbours(int[][] input, int i, int j)
        {
            ...
            if (i == 0)
            {
                if (j == 0)
                {
                    neighbours = new[]
                    {
                        input[i][1], input[1][j], input[1][1], input[rowLength-1][columnLength-1], input[rowLength-1][j], input[rowLength-1][1], input[i][columnLength-1], input[1][columnLength-1] 
                    };
            ...
            }else if (i == rowLength - 1)
            {
                if (j == 0)
                {
                    neighbours = new[]
                    {
                        input[rowLength-2][0], input[rowLength-2][1], input[rowLength-1][1],input[0][j], input[0][1], input[0][columnLength-1], input[rowLength-1][columnLength-1], input[rowLength-2][columnLength-1]
                    };
            ...
            else
            {
                if (j == 0)
                {
                    neighbours = new[]
                    {
                        input[i - 1][j], input[i - 1][1], input[i][1], input[i + 1][j], input[i + 1][1],
