...
namespace conways_game_of_life_tests
{
    public class GenerationTests
    {
        ...
        [Fact]
        public void GetNeighboursShould_ReturnAListWith8ellsWithCorrectNumberOfDeadCellsAndLiveCells_WhenTheGenerationIs3times3()
        {
            var cellStates = new[] {
                new[]{_dead, _dead, _dead},
                new[]{_dead, _live, _dead},
        ...
        [Fact]
        public void GetNeighboursShould_ReturnACorrectListOfNeighbours_WhenTheCellIsOnLeftBorder()
        {
            var cellStates = new[] {
                new[]{_dead, _dead, _dead, _dead},
                new[]{_dead, _live, _dead, _dead},
        ...
        [Fact]
        public void GetNeighboursShould_ReturnACorrectListOfNeighbours_WhenTheCellIsOnTopBorder()
        {
            var cellStates = new[] {
                new[]{_dead, _dead, _dead, _dead},
                new[]{_dead, _live, _dead, _dead},
        ...
        [Fact]
        public void GetNeighboursShould_ReturnACorrectListOfNeighbours_WhenTheCellIsOnLeftTopCorner()
        {
            var cellStates = new[] {
                new[]{_dead, _dead, _dead, _dead},
                new[]{_dead, _live, _live, _dead},
                new[]{_dead, _dead, _dead, _dead}
            };
        ...
        [Fact]
        public void GetNeighboursShould_ReturnACorrectListOfNeighbours_WhenTheCellIsOnRightBorder()
        {
            var cellStates = new[] {
                new[]{_live, _dead, _dead, _dead},
                new[]{_dead, _live, _live, _dead},
                new[]{_dead, _dead, _dead, _live}
            };
        ...
        [Fact]
        public void GetNeighboursShould_ReturnACorrectListOfNeighbours_WhenTheCellIsOnBottomRightCorner()
        {
            var cellStates = new[] {
                new[]{_live, _dead, _dead, _dead},
                new[]{_dead, _live, _live, _dead},
