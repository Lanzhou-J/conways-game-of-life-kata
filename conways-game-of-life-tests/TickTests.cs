...
namespace conways_game_of_life_tests
{
    public class TickTests
    {
        ...
        [Fact]
        public void GenerateNewGenerationShould_ReturnAGenerationOfDeadCells_WhenALiveCellIsUnderpopulated_AtADifferentPosition()
        {
            var deadCell = new Cell();
            var liveCell = new Cell(State.Live);
            var cells = new[] {
                new[]{liveCell, deadCell,deadCell, deadCell},
                new []{deadCell, deadCell,deadCell, deadCell},
                new []{deadCell, deadCell,deadCell, deadCell},
            };
